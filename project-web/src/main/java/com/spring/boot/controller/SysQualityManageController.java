...
public class SysQualityManageController {
    ...
    public R getSysQualityManageList(@RequestParam(value = "limit", required = false) String limit, @RequestParam(value = "offset", required = false) String offset) {
        ...
        Map<String, Object> map = sysQualityManageService.getSysQualityManageList(Integer.valueOf(limit), Integer.valueOf(offset));
